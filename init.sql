...
ALTER TABLE guilds ADD COLUMN IF NOT EXISTS tag VARCHAR(4);
ALTER TABLE guilds ADD COLUMN IF NOT EXISTS badge INTEGER NOT NULL DEFAULT 0;
ALTER TABLE guilds ADD COLUMN IF NOT EXISTS badge_color_primary VARCHAR(7) NOT NULL DEFAULT '#000000';
ALTER TABLE guilds ADD COLUMN IF NOT EXISTS badge_color_secondary VARCHAR(7) NOT NULL DEFAULT '#000000';
ALTER TABLE guilds ADD COLUMN IF NOT EXISTS badge_hash TEXT NOT NULL DEFAULT '';
ALTER TABLE guilds ADD COLUMN IF NOT EXISTS brand_color_primary VARCHAR(7);
ALTER TABLE guilds ADD COLUMN IF NOT EXISTS game_application_ids JSONB NOT NULL DEFAULT '[]'::jsonb;
ALTER TABLE guilds ADD COLUMN IF NOT EXISTS traits JSONB NOT NULL DEFAULT '[]'::jsonb;
ALTER TABLE guilds ADD COLUMN IF NOT EXISTS visibility INTEGER NOT NULL DEFAULT 1;
